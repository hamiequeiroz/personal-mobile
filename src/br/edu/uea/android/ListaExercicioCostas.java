...
public class ListaExercicioCostas extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		protected void onListItemClick(ListView l,View v,int position, long id){
			...
			Intent i = new Intent(this,ListaImagensCostas.class);
		...
		public void mensagemExibir(String titulo, String texto) {
			AlertDialog.Builder mensagem = new AlertDialog.Builder(ListaExercicioCostas.this);
